...
<center>
  <form id="test" class="ui  form" name="reciever" method="POST" action="res.php"  enctype="multipart/form-data">
	<h4 class="ui center aligned top attached header">Please Enter Reciever Details</h4>
    ...
    <div class="field">
      ...
      <select name="group"
      class="ui fluid dropdown" required>
        <option value="">Select Group</option>
    <option value="a+">A+</em></option>
    ...
    <div class="field">
      ...
      <input type="text" id="mobile" name="mobile" placeholder="Enter your number" required>
		...
		<div class="field">
			<label for="r1"> photo:</label>
			<input type="file" id="r1" name="r1" placeholder="Place your photo" required>
		</div>
	</div>
	<div id="form-message" class="ui attached message">
		<i class="icon help"></i>
		 <a href="#">Signup as Hospital</a>.
	</div>

  <br>
	<input value="Register" class="ui bottom attached fluid button" name="submit_reciever_signup" type="submit">
</form></center>
</div>
